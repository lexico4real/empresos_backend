export const INTL_BANKS = [
  {
    ...
    banks: [
      ...
      {
        bankName: 'Clydesdale Bank PLC',
        swiftCode: 'CLYDGB2S',
      },
      {
        bankName: 'Co-operative Bank PLC',
        swiftCode: 'CPBKGB22',
      },
      {
